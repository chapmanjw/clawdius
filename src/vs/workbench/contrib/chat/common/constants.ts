...
export function getComputedDefaultSessionType(
	...
	// Anchored ahead of the local-agent gate below so the Clawdius `claudeAh` default is not shadowed by it.
...
/** Maps the {@link ChatConfiguration.EditorDefaultProvider} setting value to a session type. */
