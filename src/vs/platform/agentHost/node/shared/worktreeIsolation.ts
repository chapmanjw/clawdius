...
export class WorktreeIsolation extends Disposable {
	...
	/** Branch-name generator for worktree sessions; the fork-local deterministic generator unless a test supplies an override. */
	...
	constructor(
		...
		super();
		this._branchNameGenerator = branchNameGenerator ?? new AgentBranchNameGenerator(this._logService);
	}
