...
# clean install + compile. Prerequisites in BUILD.md (VS 2022 Build Tools + Spectre libs, Node from
...
if (-not (Test-Path $vswhere)) { throw "vswhere not found. Install the VS 2022 C++ Build Tools (see BUILD.md)." }
...
if (-not $vs) { throw "No Visual Studio install with the C++ toolset (VCTools) was found. See BUILD.md." }
