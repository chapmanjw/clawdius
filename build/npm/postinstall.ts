...
async function main() {
	...
	const claudeMdLinkType = ensureAgentHarnessLink(path.join('..', '.github', 'clawdius-instructions.md'), claudeMdLink);
	if (claudeMdLinkType !== 'existing') {
		log('.', `Created ${claudeMdLinkType} .claude/CLAUDE.md -> .github/clawdius-instructions.md`);
	}
