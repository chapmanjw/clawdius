...
export class CustomizationsToolbarContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
		...
		this._register(autorun(reader => {
			// Read for reactivity: the visible sections depend on which harness is active.
			...
			for (const config of CUSTOMIZATION_ITEMS) {
				...
				// CLAWDIUS: upstream shows the harness-settings section only for the Codex harness, which the fork removes.
