...
// UNIVERSAL rules run on EVERY scanned file regardless of OWNED/marked scoping: these markers of the private
// multi-agent planning workflow have no legitimate use anywhere in the public tree. They are what a bare
...
// Internal planning documents belong in the private docs repo, never the public source tree.
...
for (const f of files) {
  ...
  if (INTERNAL_DOC_PATH.test(nf)) { console.error(`[internal-planning-doc] ${f}: planning docs belong in the private docs repo, not the source tree`); findings++ }
