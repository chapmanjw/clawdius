...
// CLAWDIUS-BEGIN brand sweep (productQualityType context-key description)
export const ProductQualityContext = new RawContextKey<string>('productQualityType', '', localize('productQualityType', "Quality type of Clawdius"));
// CLAWDIUS-END
