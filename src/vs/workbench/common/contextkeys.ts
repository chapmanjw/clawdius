...
// CLAWDIUS-BEGIN brand sweep (context-key description self-reference)
export const InAutomationContext = new RawContextKey<boolean>('inAutomation', false, localize('inAutomation', "Whether Clawdius is running under automation/smoke test"));
// CLAWDIUS-END
