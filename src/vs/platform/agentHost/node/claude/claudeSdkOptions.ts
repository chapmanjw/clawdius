...
export async function buildOptions(
	...
	return {
		...
		// Project the ordered working-directory tail onto the SDK's additionalDirectories as absolute paths;
		// omitted entirely for a single-root session so the SDK keeps its default.
