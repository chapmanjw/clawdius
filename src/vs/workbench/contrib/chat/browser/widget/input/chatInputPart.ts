...
export class ChatInputPart extends Disposable implements IHistoryNavigationWidget {
	...
	private _usesHarnessProviderIcon(): boolean {
		const sessionType = this.getCurrentSessionType();
		// CLAWDIUS: upstream also checks SessionType.Codex / SessionType.AgentHostCodex here,
		// but Clawdius never registers a Codex session type (no Codex agent, extension-host or
		// agent-host). Only the retained Claude harness variants apply.
