...
class TerminalInitialHintWidget extends Disposable {
	...
	private _getHintContent() {
		...
		// CLAWDIUS-BEGIN drop the "Type [[copilot]] to use Copilot CLI" terminal hint (no Copilot CLI in Clawdius).
		// Show the terminal suggest hint whenever suggestions are enabled, rather than only when AI features are hidden.
